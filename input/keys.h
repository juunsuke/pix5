...
// All these codes have the exact same value as the SDL2 scancodes
// They are redefined here to avoid requiring SDL2 in order to use the library,
// and to provide a level of independance from it
//
// Please see "Key.h" for detailed information on their meaning and usage
//

// Copied from SDL_scancode.h, and adjusted for PIX
